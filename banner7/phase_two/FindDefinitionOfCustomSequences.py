...
from tools.ObjectDataFileTools import add_new_object_element_to_object_data_file, extract_sequences_attributes_from_database, \
     extract_unique_dependencies_types_from_data_file

if __name__ == "__main__":
    object_data = "../../object_data.json"

    unique_sequences = extract_unique_dependencies_types_from_data_file(input_file_name=object_data, database_object_type=DatabaseObject.SEQUENCE, environment=DatabaseEnvironment.BANNER7)
