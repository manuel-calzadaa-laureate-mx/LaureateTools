...
def fetch_table_columns_for_tables(db_pool: OracleDBConnectionPool, table_names: [str]):
    """
...
def fetch_table_columns_for_tables_grouped_by_schema_and_table_name(db_pool: OracleDBConnectionPool,
                                                                    table_names: [str]):
    results = fetch_table_columns_for_tables(db_pool=db_pool, table_names=table_names)
    grouped_columns = {}
    for row in results:
...
def fetch_table_attributes_for_tables(db_pool: OracleDBConnectionPool, table_names: [str]):
    """
...
def fetch_table_attributes_for_tables_grouped_by_schema_and_table_name(db_pool: OracleDBConnectionPool,
                                                                       table_names: [str]):
    results = fetch_table_attributes_for_tables(db_pool=db_pool, table_names=table_names)
    grouped_attributes = {}
    for row in results:
...
def fetch_column_comments_for_tables_grouped_by_schema_and_table_name(db_pool: OracleDBConnectionPool,
                                                                      table_names: [str]):
    """
...
def fetch_indexes_for_tables_grouped_by_schema_and_table_name(db_pool: OracleDBConnectionPool, table_names: [str]):
    """
...
def fetch_full_indexes_for_tables_grouped_by_schema_and_table_name(db_pool: OracleDBConnectionPool,
                                                                   table_names: [str]):
    """
